    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attempt_status', models.CharField(choices=[('успешно', 'успешно'), ('не успешно', 'не успешно')], max_length=200, verbose_name='статус попытки ')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('first_send_datetime', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Дата и время первой отправки')),
                ('periodicity', models.CharField(choices=[('ежедневно', 'daily'), ('еженедельно', 'weekly'), ('ежемесячно', 'monthly')], default='ежедневно', max_length=20, verbose_name='Периодичность')),
            ...
            options={
                ...
                'permissions': [('can_change_status_mailingsetting', 'Can change status Настройка рассылки'), ('can_view_mailingsetting', 'Can view Настройка рассылки ')],
            },
        ),
        migrations.CreateModel(
            name='MessageMailing',
